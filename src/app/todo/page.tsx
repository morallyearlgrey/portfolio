          ...
          <div className="w-full flex flex-1 justify-between h-full overflow-y-auto custom-scrollbar p-4 flex-col gap-y-8">
            <div className="h-full">
                <Image
                    ...
                    height={2000}
                />
                <div className="flex flex-col -translate-y-45 w-full md:w-fit md:m-10 md:bg-[var(--darker-blue)] py-3 px-12 rounded-lg md:border-3 md:border-black text-[var(--white)] ">
